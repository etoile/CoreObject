...
- (void)testParent
{
    ...
    UKObjectsEqual([CORelationshipRecord recordWithUUID: u1 property: @"child"],
                   [cache parentForUUID: u2]);
    ...
    UKObjectsEqual([CORelationshipRecord recordWithUUID: u3 property: @"child"],
                   [cache parentForUUID: u2]);
...
- (void)testParentWithInnerItemSet
{
    ...
    UKObjectsEqual([CORelationshipRecord recordWithUUID: p1 property: @"children"],
                   [cache parentForUUID: u2]);
    UKObjectsEqual([CORelationshipRecord recordWithUUID: p1 property: @"children"],
                   [cache parentForUUID: u3]);
    ...
    UKObjectsEqual([CORelationshipRecord recordWithUUID: p2 property: @"children"],
                   [cache parentForUUID: u2]);
    UKNil([cache parentForUUID: u3]);
    UKObjectsEqual([CORelationshipRecord recordWithUUID: p1 property: @"children"],
                   [cache parentForUUID: u4]);
...
- (void)testReferences
{
    ...
    UKObjectsEqual(S([CORelationshipRecord recordWithUUID: u1 property: @"link1"],
                     ...
                     [CORelationshipRecord recordWithUUID: u3 property: @"link1"]),
                   [cache referrersForUUID: u2]);
...
- (void)testReferencesSet
{
    ...
    UKObjectsEqual(S([CORelationshipRecord recordWithUUID: g1 property: @"groupContents"]),
                   [cache referrersForUUID: u1]);

    UKObjectsEqual(S([CORelationshipRecord recordWithUUID: g1 property: @"groupContents"],
                     [CORelationshipRecord recordWithUUID: g2 property: @"groupContents"]),
                   [cache referrersForUUID: u2]);

    UKObjectsEqual(S([CORelationshipRecord recordWithUUID: g2 property: @"groupContents"],
                     [CORelationshipRecord recordWithUUID: t1 property: @"taggedObjects"]),
                   [cache referrersForUUID: u3]);

    UKObjectsEqual(S([CORelationshipRecord recordWithUUID: t1 property: @"taggedObjects"]),
                   [cache referrersForUUID: g1]);
