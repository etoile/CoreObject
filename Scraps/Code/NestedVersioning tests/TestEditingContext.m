...
- (void)testManyToMany
{
    ...
    UKObjectsEqual([NSSet set],
                   [ctx1 objectsWithReferencesToObject: o2 inAttribute: kCOReferences]);

    [self addReferenceToObject: o1 toObject: t3];
    [self addReferenceToObject: o2 toObject: t2];

    UKObjectsEqual(S(t1, t2, t3),
                   [ctx1 objectsWithReferencesToObject: o1 inAttribute: kCOReferences]);
