...
- (void)testPullSimpleFastForward
{
    ...
    UKStringsEqual(@"yellow",
                   [[[ctx editingContextForEditingBranchOfPersistentRoot: u1BranchA] persistentRootTree] valueForAttribute: @"color"]);
    UKStringsEqual(@"red",
                   [[[ctx editingContextForEditingBranchOfPersistentRoot: u1BranchB] persistentRootTree] valueForAttribute: @"color"]);
...
- (void)testPullWithMerge
{
    ...
    COSubtree *i1 = [[COSubtreeFactory factory] createPersistentRootWithRootItem: subtreeInitialVersion(
            contentsUUID)
                                                                     displayName: @"My Document"
                                                                           store: store];
...
- (void)testPullWithNestedPersistentRootMerge
{
    ...
    COSubtree *innerdoc = [[COSubtreeFactory factory] createPersistentRootWithRootItem: subtreeInitialVersion(
            innerContentsUUID)
