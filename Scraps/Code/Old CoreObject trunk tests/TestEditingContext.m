...
- (void)testRootObjectReferencesAccrossPersistentRoots
{
    ...
    UKObjectsSame(newObj2,
                  [newPersistentRoot loadedObjectForUUID: [persistentRoot2 persistentRootUUID]]);
    UKObjectsSame(newObj,
                  [newPersistentRoot2 loadedObjectForUUID: [persistentRoot persistentRootUUID]]);
    UKObjectsSame(newObj2,
                  [newPersistentRoot loadedObjectForUUID: [[persistentRoot2 commitTrack] UUID]]);
    UKObjectsSame(newObj,
                  [newPersistentRoot2 loadedObjectForUUID: [[persistentRoot commitTrack] UUID]]);
