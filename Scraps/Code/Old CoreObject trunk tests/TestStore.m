...
- (void)testFullTextSearch
{
    ...
    if ([searchResults count] == 2)
    {
        ...
        UKObjectsEqual([NSNumber numberWithUnsignedLongLong: [c2 revisionNumber]],
                       [result1 objectForKey: @"revisionNumber"]);
        ...
        UKObjectsEqual([NSNumber numberWithUnsignedLongLong: [c4 revisionNumber]],
                       [result2 objectForKey: @"revisionNumber"]);
...
- (void)testBranch
{
    ...
    UKStringsEqual(@"mammals",
                   [[c4 allValuesAndPropertiesForObjectUUID: o3] objectForKey: @"name"]);
}
