...
- (id)init
{
    ...
    ETEntityDescription *docEntity = [[ETEntityDescription alloc] initWithName: @"TypewriterDocument"];
    {
        ...
        ETPropertyDescription *paragraphsProperty =
            [ETPropertyDescription descriptionWithName: @"paragraphs"
                                                  type: (id)@"Anonymous.TypewriterParagraph"];
    ...
    ETEntityDescription *paragraphEntity = [[ETEntityDescription alloc] initWithName: @"TypewriterParagraph"];
    {
        ...
        ETPropertyDescription *documentProperty =
            [ETPropertyDescription descriptionWithName: @"document"
                                                  type: (id)@"Anonymous.TypewriterDocument"];
...
- (void)applicationDidFinishLaunching: (NSNotification *)notif
{
    ...
    {
        EWDocument *doc = [[EWDocument alloc] initWithPersistentRoot: dict[@"proot"]
                                                               title: dict[@"title"]];
