...
- (NSInteger) handleInsertion: (COAttributedStringDiffOperationInsertAttributedSubstring *)op currentOffset: (NSInteger)offset target: (NSMutableAttributedString *)string
{
...
- (NSInteger) handleDeletion: (COAttributedStringDiffOperationDeleteRange *)op currentOffset: (NSInteger)offset target: (NSMutableAttributedString *)string
{
...
- (NSInteger) handleReplacement: (COAttributedStringDiffOperationReplaceRange *)op currentOffset: (NSInteger)offset target: (NSMutableAttributedString *)string
{
    NSDictionary *modifyDeletionAttribs = @{ NSForegroundColorAttributeName : [[NSColor redColor] colorWithAlphaComponent: 0.3],
                                             NSStrikethroughStyleAttributeName : [NSNumber numberWithInteger: NSUnderlineStyleSingle] };
    
    NSDictionary *modifyInsertionAttribs = @{ NSForegroundColorAttributeName : [NSColor colorWithCalibratedRed:0 green:0.5 blue:0 alpha:1],
                                              NSFontAttributeName : [NSFont boldSystemFontOfSize: [NSFont systemFontSize]] };
...
- (NSInteger) handleAddAttribute: (COAttributedStringDiffOperationAddAttribute *)op currentOffset: (NSInteger)offset target: (NSMutableAttributedString *)string
{
    // TODO: Do something to indicate an attribute was added
    return 0;
}

- (NSInteger) handleRemoveAttribute: (COAttributedStringDiffOperationRemoveAttribute *)op currentOffset: (NSInteger)offset target: (NSMutableAttributedString *)string
{
    // TODO: Do something to indicate an attribute was removed
    return 0;
}

- (NSInteger) handleOp: (id<COAttributedStringDiffOperation>)op currentOffset: (NSInteger)offset target: (NSMutableAttributedString *)string
{
    if ([op isKindOfClass: [COAttributedStringDiffOperationInsertAttributedSubstring class]])
    {
        return [self handleInsertion: (COAttributedStringDiffOperationInsertAttributedSubstring *)op currentOffset: offset target: string];
    }
    else if ([op isKindOfClass: [COAttributedStringDiffOperationDeleteRange class]])
    {
        return [self handleDeletion: (COAttributedStringDiffOperationDeleteRange *)op currentOffset: offset target: string];
    }
    else if ([op isKindOfClass: [COAttributedStringDiffOperationReplaceRange class]])
    {
        return [self handleReplacement: (COAttributedStringDiffOperationReplaceRange *)op currentOffset: offset target: string];
    }
    else if ([op isKindOfClass: [COAttributedStringDiffOperationAddAttribute class]])
    {
        return [self handleAddAttribute: (COAttributedStringDiffOperationAddAttribute *)op currentOffset: offset target: string];
    }
    else if ([op isKindOfClass: [COAttributedStringDiffOperationRemoveAttribute class]])
    {
        return [self handleRemoveAttribute: (COAttributedStringDiffOperationRemoveAttribute *)op currentOffset: offset target: string];
    }
    else
    {
