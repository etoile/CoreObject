...
{
    const CGFloat a = FractionFromHex([color substringWithRange: NSMakeRange(1, 2)]);
    const CGFloat r = FractionFromHex([color substringWithRange: NSMakeRange(3, 2)]);
    const CGFloat g = FractionFromHex([color substringWithRange: NSMakeRange(5, 2)]);
    const CGFloat b = FractionFromHex([color substringWithRange: NSMakeRange(7, 2)]);
