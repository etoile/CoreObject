...
- (void)testBasic
{
    ...
    [childCtx2 removeObject: subchild2Ctx2
                    atIndex: ETUndeterminedIndex
                       hint: nil
                forProperty: @"contents"]; // Remove "Salad"
    ...
    [childCtx2 insertObject: subchild4Ctx2
                    atIndex: ETUndeterminedIndex
                       hint: nil
                forProperty: @"contents"]; // Add "Salsa"
    [childCtx2 setValue: @"Snacks" forProperty: @"label"];

    // Now create a diff
    COItemGraphDiff *diff = [COItemGraphDiff diffItemTree: ctx1
                                             withItemTree: ctx2
                                         sourceIdentifier: @"exampleDiff"];
    UKNotNil(diff);
...
- (void)testMove
{
    ...
    [child1Ctx2 removeObject: subchild1Ctx2
                     atIndex: ETUndeterminedIndex
                        hint: nil
                 forProperty: @"contents"];
    [child2Ctx2 insertObject: subchild1Ctx2
                     atIndex: ETUndeterminedIndex
                        hint: nil
                 forProperty: @"contents"];
...
{
    NSString *path = [[NSBundle bundleForClass: [self class]] pathForResource: aResource
                                                                       ofType: @"json"];
