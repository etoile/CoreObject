...
- (void)testEqualsAndMinusConvenienceMethods
{
    ...
    UKObjectsEqual(S(attr1b),
                   [COAttributedStringAttribute attributeSet: S(attr1a, attr1b)
                                                    minusSet: S(attr2a)]);
    UKObjectsEqual(S(attr1a, attr1b),
                   [COAttributedStringAttribute attributeSet: S(attr1a, attr1b) minusSet: S()]);
}
